...
patients = [[60.0, '2017-12-24 10:12', '2018-05-01 10:00'],
            [60.0, '2017-12-28 07:52', '2018-05-01 10:00'],
            [60.0, '2017-12-28 13:43', '2018-05-01 10:00'],
            [60.0, '2017-12-28 16:25', '2018-05-01 10:00'],
            [30.0, '2017-12-24 11:31', '2018-05-01 10:00'],
            [30.0, '2017-12-24 09:22', '2018-05-01 10:00'],
            [30.0, '2017-12-24 09:12', '2018-05-01 10:00'],
            [30.0, '2017-12-24 12:15', '2018-05-01 10:00'],
            [30.0, '2017-12-24 11:47', '2018-05-01 10:00'],
            [30.0, '2017-12-27 14:42', '2018-05-01 10:00'],
            ]

start_date_raw = '2018-01-01'# '%Y-%m-%d'
end_date_raw = '2018-01-01' # '%Y-%m-%d'
start_time_raw = '09:00' # '%H:%M'
end_time_raw = '13:00' # '%H:%M'
