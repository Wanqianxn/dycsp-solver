...
patients = [[60.0, '2017-12-24 12:42', '2018-05-01 10:33'],
            [30.0, '2017-12-24 12:42', '2018-05-01 11:00'],
            [30.0, '2017-12-27 12:42', '2018-05-01 08:40'],
            ]

start_date_raw = '2018-01-01'# '%Y-%m-%d'
end_date_raw = '2018-01-01' # '%Y-%m-%d'
start_time_raw = '08:00' # '%H:%M'
end_time_raw = '09:00' # '%H:%M'
